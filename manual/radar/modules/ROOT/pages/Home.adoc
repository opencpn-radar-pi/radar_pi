...
and MARPA targets as well as _target trails_ support comparable to
commercial level radars as well as _guard zone_ support. It supports two
...
Furuno or Raymarine, see [[Adding new radar types]].
...
adding Garmin support back in with the help of @trudK45.
