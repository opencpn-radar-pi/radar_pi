...
if (radarType >= RT_HaloA) {
  ...
  HAVE_CONTROL(CT_AUTOTTRACKDOPPLER, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 1, CTD_STEP_1, OFF_ON_NAMES)
}
...
HAVE_CONTROL(CT_SCALING, CTD_AUTO_NO, CTD_DEF_ZERO, -100, CTD_MAX_100, CTD_STEP_1, CTD_NUMERIC)
