...
#define RANGE_METRIC_RT_GARMIN_HD                                              \
    { 250, 500, 750, 1000, 1500, 2000, 3000, 4000, 6000, 8000, 12000, 16000,   \
        24000, 36000, 48000, 64000 }
// Garmin mixed range is the same as nautical miles, it does not support really
// short ranges
#define RANGE_MIXED_RT_GARMIN_HD                                               \
    { 232, 1852 / 4, 1852 / 2, 1852 * 3 / 4, 1852 * 1, 1852 * 3 / 2, 1852 * 2, \
        1852 * 3, 1852 * 4, 1852 * 6, 1852 * 8, 1852 * 12, 1852 * 16,          \
        1852 * 24, 1852 * 36, 1852 * 48 }
...
// Each of the 4 spoke buffers in the line buffer can be between 128 and 252
// bytes Each byte in a spoke buffer contains 8 samples.
#define GARMIN_HD_SPOKES 720
#define GARMIN_HD_MAX_SPOKE_LEN                                                \
    252 * 8 // Bytes in internal 1 byte/sample format
