...
HAVE_CONTROL(CT_SEA, RM_SEA_AUTO_NAMES, CTD_DEF_ZERO, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
HAVE_CONTROL(CT_FTC, CTD_AUTO_NO, CTD_DEF_OFF, CTD_MIN_ZERO, 100, CTD_STEP_2, CTD_PERCENTAGE)
