...
#define RM_SEA_AUTO_NAMES { _("Harbour"), _("Offshore"), _("Coastal") }
#endif

HAVE_CONTROL(CT_BEARING_ALIGNMENT, CTD_AUTO_NO, CTD_DEF_ZERO, -1800, +1800,
    CTD_STEP_1, { wxT("*0.1 degrees") })
...
HAVE_CONTROL(CT_INTERFERENCE_REJECTION, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO,
    2, CTD_STEP_1, OFF_LOW_MEDIUM_HIGH_NAMES)
...
HAVE_CONTROL(CT_RAIN, CTD_AUTO_NO, CTD_DEF_OFF, CTD_MIN_ZERO, CTD_MAX_100,
    CTD_STEP_2, CTD_PERCENTAGE)
HAVE_CONTROL(
    CT_RANGE, CTD_AUTO_YES, 1000, CTD_MIN_ZERO, 0, CTD_STEP_1, CTD_NUMERIC)

HAVE_CONTROL(CT_SEA, RM_SEA_AUTO_NAMES, CTD_DEF_ZERO, CTD_MIN_ZERO, CTD_MAX_100,
    CTD_STEP_1, CTD_PERCENTAGE)
HAVE_CONTROL(CT_FTC, CTD_AUTO_NO, CTD_DEF_OFF, CTD_MIN_ZERO, 100, CTD_STEP_2,
    CTD_PERCENTAGE)

// HAVE_CONTROL(CT_SIDE_LOBE_SUPPRESSION, CTD_AUTO_YES, CTD_DEF_ZERO,
// CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
HAVE_CONTROL(CT_TARGET_BOOST, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 2,
    CTD_STEP_1, OFF_LOW_HIGH_NAMES)

// HAVE_CONTROL(CT_STC, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 8, CTD_STEP_1,
// CTD_NUMERIC)
HAVE_CONTROL(CT_DISPLAY_TIMING, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 255,
    CTD_STEP_1, CTD_NUMERIC) // display timing
HAVE_CONTROL(CT_MAIN_BANG_SUPPRESSION, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO,
    1, CTD_STEP_1, OFF_ON_NAMES)

// Don't forget to enable buttons and update labels in ControlsDialog.cpp around
// 1950
