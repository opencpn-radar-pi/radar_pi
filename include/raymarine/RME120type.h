...
#define RM_E120_SPOKES 250
#endif

#ifndef RM_E120_SPOKE_LEN

#define RM_E120_SPOKE_LEN (250)  // BR radars generate 512 separate values per range, at 8 bits each (according to original RMradar_pi)
