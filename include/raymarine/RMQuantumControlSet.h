...
HAVE_CONTROL(CT_BEARING_ALIGNMENT, CTD_AUTO_NO, CTD_DEF_ZERO, -1795, +1800,
    CTD_STEP_5, { wxT("*0.1 degrees") })
HAVE_CONTROL(CT_GAIN, CTD_AUTO_YES, 50, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1,
    CTD_PERCENTAGE)
HAVE_CONTROL(CT_COLOR_GAIN, CTD_AUTO_YES, 50, CTD_MIN_ZERO, CTD_MAX_100,
    CTD_STEP_1, CTD_PERCENTAGE)
HAVE_CONTROL(CT_INTERFERENCE_REJECTION, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO,
    5, CTD_STEP_1, CTD_NUMERIC)
...
HAVE_CONTROL(CT_MODE, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 4, CTD_STEP_1,
    RM_MODE_NAMES)

HAVE_CONTROL(CT_ALL_TO_AUTO, CTD_AUTO_YES, CTD_DEF_ZERO, CTD_MIN_ZERO,
    CTD_MAX_1, CTD_STEP_1, OFF_ON_NAMES)
...
// 1810 and 1960 And initialise m_xxx_button in ControlsDialog.h
