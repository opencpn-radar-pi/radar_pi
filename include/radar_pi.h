...
#define MY_API_VERSION_MINOR 18  // Needed for PluginAISDrawGL().
...
static ToolbarIconColor g_toolbarIconColor[9] = {
    TB_SEARCHING, TB_STANDBY, TB_SEEN,   TB_SEEN,  TB_SEEN,
...
extern GeoPosition local_position(GeoPosition& pos, double distance,
                                  double bearing);
...
static const wxString RangeUnitDescriptions[3] = {wxT("kn"), wxT("kph"),
                                                  wxT("kn")};
