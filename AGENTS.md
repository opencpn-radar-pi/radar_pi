...
This is a plugin for OpenCPN, using C++, wxWidgets and CMake.
...
**MANDATORY:** Always add a one line update to CHANGELOG-PLUGIN.md for each set of commits pertaining to a separate issue, PR or general change.
