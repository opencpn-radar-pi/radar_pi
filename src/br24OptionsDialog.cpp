...
br24OptionsDialog::br24OptionsDialog(wxWindow *parent, PersistentSettings &settings, RadarType radar_type)
  ...
  wxStaticBox *targetColourBox = new wxStaticBox(this, wxID_ANY, _("Target colors"));
  wxStaticBoxSizer *targetColourSizer = new wxStaticBoxSizer(targetColourBox, wxVERTICAL);

  wxStaticText *arpaText = new wxStaticText(this, wxID_ANY, _("ARPA edge color"));
  targetColourSizer->Add(arpaText, 0, wxALL, border_size);
  ...
  targetColourSizer->Add(m_ArpaColour);

  wxStaticText *aisText = new wxStaticText(this, wxID_ANY, _("AIS text color"));
  targetColourSizer->Add(aisText, 0, wxALL, border_size);
  ...
  targetColourSizer->Add(m_AisTextColour);
  ...
  DisplayOptionsBox->Add(targetColourSizer, 0, wxALL | wxEXPAND, border_size);
