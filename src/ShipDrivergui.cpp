...
ShipDriverBase::ShipDriverBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_gaugeRudderPort->SetForegroundColour( wxColour( 255, 255, 255 ) );
	...
	m_gaugeRudderStbd->SetForegroundColour( wxColour( 255, 255, 255 ) );
	m_gaugeRudderStbd->SetBackgroundColour( wxColour( 0, 255, 64 ) );
