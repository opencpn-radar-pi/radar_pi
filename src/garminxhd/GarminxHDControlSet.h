...
HAVE_CONTROL(CT_RAIN, CTD_AUTO_YES, CTD_DEF_OFF, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
...
HAVE_CONTROL(CT_SEA, CTD_AUTO_YES, CTD_DEF_OFF, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
