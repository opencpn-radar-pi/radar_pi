...
HAVE_CONTROL(CT_NO_TRANSMIT_START, CTD_AUTO_OFF, CTD_DEF_OFF, -180, +180, CTD_STEP_1, CTD_NUMERIC)
HAVE_CONTROL(CT_NO_TRANSMIT_END, CTD_AUTO_OFF, CTD_DEF_OFF, -180, +180, CTD_STEP_1, CTD_NUMERIC)
