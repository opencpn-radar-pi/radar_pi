...
#ifndef AUTO_CALM_MEDIUM_ROUGH
#define AUTO_CALM_MEDIUM_ROUGH \
  { _("Auto Calm"), _("Auto Medium"), _("Auto Rough") }
#endif
...
HAVE_CONTROL(CT_SEA, AUTO_CALM_MEDIUM_ROUGH, CTD_DEF_OFF, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
