...
HAVE_CONTROL(CT_OVERLAY_CANVAS0, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 1, CTD_STEP_1, OFF_ON_NAMES)
HAVE_CONTROL(CT_OVERLAY_CANVAS1, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, 1, CTD_STEP_1, OFF_ON_NAMES)
