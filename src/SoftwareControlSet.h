...
#ifndef TRUE_MOTION_NAMES
#define TRUE_MOTION_NAMES \
  { _("Off"), _("Wanted On"), _("On")}
#endif
#define TRUE_MOTION_OFF (0)  
#define TRUE_MOTION_WANTED (1)
#define TRUE_MOTION_ON (2)
...
HAVE_CONTROL(CT_TRUE_MOTION, CTD_AUTO_NO, CTD_DEF_ZERO, CTD_MIN_ZERO, ORIENTATION_NUMBER - 1, CTD_STEP_1, TRUE_MOTION_NAMES)
