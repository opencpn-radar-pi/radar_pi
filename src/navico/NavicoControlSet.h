...
#define SLOW_FAST \
  { _("Slow"), _("Fast") }
#endif
#ifndef NAVICO_SEA_AUTO
#define NAVICO_SEA_AUTO \
  { _("Harbour"), _("Offshore") }
#endif
#ifndef NAVICO_HALO_SEA_AUTO
#define NAVICO_HALO_SEA_AUTO \
  { _("Harbour"), _("Offshore") }  // TODO I think HALO has more?!
#endif
...
if (radarType == RT_HaloA || radarType == RT_HaloB) {
  HAVE_CONTROL(CT_SEA, NAVICO_HALO_SEA_AUTO, CTD_DEF_ZERO, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
} else if (radarType == RT_4GA || radarType == RT_4GB || radarType == RT_BR24) {
  HAVE_CONTROL(CT_SEA, NAVICO_SEA_AUTO, CTD_DEF_ZERO, CTD_MIN_ZERO, CTD_MAX_100, CTD_STEP_1, CTD_PERCENTAGE)
} else {
